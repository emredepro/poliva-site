...
export default function Inicio() {
  ...
  return (
    <div style={{ position: 'relative', minHeight: '100vh', backgroundColor: 'black', color: 'white', overflowX: 'hidden', fontFamily: "'Avant Garde', sans-serif" }}>
      ...
      {/* 1. VÍDEO DE FUNDO (SOMBRIO -10% POSIÇÃO) */}
      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        ...
        <nav style={{ position: 'fixed', top: 0, width: '100%', backgroundColor: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(10px)', borderBottom: '1px solid rgba(255,255,255,0.05)', padding: '20px 0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <main style={{ paddingTop: '180px', paddingBottom: '100px', maxWidth: '1100px', margin: '0 auto', textAlign: 'center', paddingLeft: '20px', paddingRight: '20px' }}>
          ...
          {/* PLAYER YOUTUBE */}
          <div style={{ width: '100%', maxWidth: '850px', aspectRatio: '16/9', margin: '0 auto 100px', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.9)', backgroundColor: '#000' }}>
          ...
          {/* CARROSSEL DINÂMICO SLIDE */}
          <section style={{ marginBottom: '180px' }}>
            <h3 style={{ fontSize: '12px', letterSpacing: '0.3em', textTransform: 'lowercase', color: '#a855f7', marginBottom: '50px' }}>o que o seu momento pede?</h3>
            
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <button onClick={prevSlide} style={{ background: 'none', border: 'none', color: 'white', fontSize: '30px', cursor: 'pointer', padding: '20px', zIndex: 20 }}>‹</button>
                ...
                <div style={{ display: 'flex', transition: 'transform 0.5s ease-in-out', transform: `translateX(-${currentIndex * 100}%)` }}>
                  {playlists.map((item, index) => (
                    <div key={index} style={{ minWidth: '100%', padding: '0 10px' }}>
                      <div style={{ width: '100%', aspectRatio: '1/1', marginBottom: '25px', border: '1px solid rgba(255,255,255,0.1)', overflow: 'hidden' }}>
              ...
              <button onClick={nextSlide} style={{ background: 'none', border: 'none', color: 'white', fontSize: '30px', cursor: 'pointer', padding: '20px', zIndex: 20 }}>›</button>
            </div>
          </section>
        </main>

        {/* RODAPÉ PRETO E BRANCO MINIMALISTA */}
        <footer style={{ backgroundColor: 'black', borderTop: '1px solid rgba(255,255,255,0.05)', padding: '100px 40px 60px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', color: 'white', fontSize: '14px', lineHeight: '2', letterSpacing: '0.05em' }}>
            
            <h4 style={{ fontSize: '20px', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'white', marginBottom: '25px', fontWeight: 'bold' }}>cøntatø</h4>
            
            <p style={{ marginBottom: '10px' }}>para shøws e parcerias</p>
            <p>e-mail: contato@polivaoficial.com.br</p>
            <p>redes sociais: @polivaoficial</p>
            
            <p style={{ marginTop: '20px' }}>telefone: 22 98802-3803</p>

            <div style={{ marginTop: '80px', fontSize: '10px', color: 'rgba(255,255,255,0.3)', letterSpacing: '0.1em' }}>
