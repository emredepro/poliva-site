  ...
  return (
    <div style={{ backgroundColor: 'black', minHeight: '100vh', color: 'white', overflowX: 'hidden', fontFamily: "'Avant Garde', sans-serif" }}>
      ...
      <div className={`page-content ${loading ? 'hidden' : 'visible'}`}>
        ...
        <main className="main-scroll">
          <section className="hero-section">
            <h1 className="hero-title anim-instant">Música que desperta, <br/><span style={{ color: '#a855f7' }}>Show que vira portal</span></h1>
            <div className="citation responsiva anim-instant">
          ...
          <section className="section-block spacer-lg">
            <div className="brutal-header anim-instant">
              <h2>pølivessense, o show:</h2>
              <p className="bold-sub">assista abaixo na íntegra</p>
            </div>
            <div className="video-player-shield">
        ...
        <a href="https://wa.me/message/L5OXQTU6PDIFF1" target="_blank" className="wa-fixed">
          <img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" alt="WhatsApp" />
        </a>

        <footer className="footer-black">
          <div className="footer-content anim-instant">
      ...
      <style jsx global>{`
        ...
        .wa-fixed { position: fixed; bottom: 120px; right: 30px; width: 50px; z-index: 8000; }
        ...
        .marquee-box { width: 100%; overflow: hidden; border-bottom: 1px solid #333; padding-bottom: 5px; margin-bottom: 5px; }
