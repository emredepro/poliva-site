  ...
  return (
    <div style={{ position: 'relative', minHeight: '100vh', backgroundColor: 'black', color: 'white', overflowX: 'hidden', fontFamily: "'Avant Garde', sans-serif" }}>
      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        ...
        {/* MENU COM INTERATIVIDADE (HOVER/ACTIVE) */}
        ...
        <main style={{ paddingTop: '200px', textAlign: 'center' }}>
          ...
          <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 20px' }}>
            ...
            {/* CAIXA DO SHOW COM MOVIMENTO HOVER */}
            <div className="show-box" style={{ 
              ...
              <h2 style={{ fontSize: '24px', letterSpacing: '0.1em', fontWeight: 'bold', color: 'white', marginBottom: '10px' }}>pølivessense, o show:</h2>
          ...
          {/* CARROSSEL PONTA A PONTA COM DOTS NO TOPO */}
          <section style={{ marginBottom: '150px', width: '100%' }}>
            ...
            <div style={{ position: 'relative', overflow: 'hidden', width: '100vw' }}>
              <div style={{ display: 'flex', transition: 'transform 0.6s cubic-bezier(0.23, 1, 0.32, 1)', transform: `translateX(-${currentIndex * 100}vw)` }}>
                {playlists.map((item, index) => (
                  <div key={index} style={{ minWidth: '100vw', display: 'flex', justifyContent: 'center', padding: '0 10%' }}>
                    <div className="playlist-card" style={{ width: '100%', maxWidth: '400px', textAlign: 'center' }}>
                      ...
                      <button style={{ backgroundColor: 'transparent', border: '1px solid #a855f7', color: '#a855f7', fontSize: '12px', padding: '15px 30px', cursor: 'pointer', letterSpacing: '0.2em' }}>OUÇA AQUI</button>
                    </div>
                  </div>
                ))}
              </div>
        ...
        {/* RODAPÉ COMPACTO RENDE À BASE */}
        <footer style={{ backgroundColor: 'black', borderTop: '1px solid rgba(255,255,255,0.1)', padding: '40px 20px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto', textAlign: 'center', color: 'white', fontSize: '14px', letterSpacing: '0.05em' }}>
            <h4 style={{ fontSize: '20px', fontWeight: 'bold', textTransform: 'uppercase', marginBottom: '15px' }}>cøntatø</h4>
            ...
            <div style={{ marginTop: '40px', fontSize: '10px', color: 'rgba(255,255,255,0.3)' }}>
      ...
      <style jsx global>{`
        .nav-item { color: white; transition: 0.3s; text-decoration: none; }
        ...
        .playlist-card img { transition: 0.5s; }
