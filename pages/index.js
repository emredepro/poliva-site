  ...
  return (
    <div style={{ backgroundColor: 'black', minHeight: '100vh', color: 'white', overflowX: 'hidden', fontFamily: "'Avant Garde', sans-serif" }}>
        ...
        <main className="main-scroll">
          ...
          <section className="section-block spacer-lg">
            ...
            <div className="video-player interactive-zoom video-unblock">
               <iframe 
                src="https://www.youtube.com/embed/4PbdupC3wrg?vq=hd1080&rel=0" 
                frameBorder="0" 
      ...
      <style jsx global>{`
        ...
        .brutal-header h2, .brutal-header h3 { font-size: clamp(1.1rem, 4vw, 1.8rem); font-weight: bold; text-transform: lowercase; line-height: 1; }
        .bold-sub { font-size: clamp(1rem, 3.3vw, 1.6rem); font-weight: bold; color: #a855f7; margin-top: 5px; text-transform: lowercase; }

        .video-player { width: 100%; max-width: 540px; margin: 60px auto; aspect-ratio: 16/9; box-shadow: 0 50px 100px rgba(0,0,0,0.9); transition: 0.4s ease; position: relative; z-index: 50; }
        .video-unblock { pointer-events: auto !important; }
        ...
        /* ANIMAÇÃO "FAST REVEAL" - CORRIGIDA PARA NÃO SUMIR */
        .anim-fade-up {
          opacity: 0;
          transform: translateY(25px);
          animation: revealStay 0.6s cubic-bezier(0.165, 0.84, 0.44, 1) forwards;
          animation-delay: 0.8s; /* Aparece logo após o loader */
        }
