  ...
  return (
    <div style={{ backgroundColor: 'black', minHeight: '100vh', color: 'white', overflowX: 'hidden', fontFamily: "'Avant Garde', sans-serif" }}>
      ...
      <style jsx global>{`
        ...
        .nav-item { color: white; text-decoration: none; font-size: 11px; letter-spacing: 0.15em; text-transform: uppercase; font-weight: bold; transition: 0.3s; }
        ...
        /* RODAPÉ AJUSTADO */
        .footer-black { background: black !important; padding: 80px 20px 100px; border-top: 1px solid #111; position: relative; z-index: 5; margin-top: 150px; }
