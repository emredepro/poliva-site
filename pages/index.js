  ...
  return (
    <div style={{ backgroundColor: 'black', minHeight: '100vh', color: 'white', overflowX: 'hidden', fontFamily: "'Avant Garde', sans-serif" }}>
      ...
      <style jsx global>{`
        ...
        .nav-item { color: white; text-decoration: none; font-size: 11px; font-weight: bold; text-transform: uppercase; letter-spacing: 0.15em; transition: 0.3s; }
        .nav-item:hover { color: #a855f7 !important; }
        .nav-item:active { color: white !important; }

        .video-bg-container { position: fixed; inset: 0; z-index: -1; }
        .video-bg { width: 100%; height: 100%; object-fit: cover; opacity: 0.35; }
        ...
        .carousel-main { display: flex; justify-content: center; margin-top: 60px; }
        ...
        .footer-black { background: black !important; padding: 100px 20px 220px; border-top: 1px solid #111; position: relative; z-index: 5; }
        ...
        .anim-reveal { opacity: 0; transform: translateY(30px); animation: revealMove 0.6s ease forwards; }
