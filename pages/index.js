// POLIVESSENSE VERSION 2.4.0 - HD VISUAL PORTAL
...
export default function Inicio() {
  ...
  const [showVideo, setShowVideo] = useState(false); // Estado para o Play do YT
  ...
  return (
    <div style={{ backgroundColor: 'black', minHeight: '100vh', color: 'white', overflowX: 'hidden', fontFamily: "'Avant Garde', sans-serif" }}>
      ...
      <div className={`page-content ${loading ? 'hidden' : 'visible'}`}>
        ...
        <main className="main-scroll">
          ...
          <section className="section-block spacer-lg">
            ...
            {/* CONTAINER DE VÍDEO COM CAPA HD */}
            <div className="video-player-container interactive-zoom">
               {!showVideo ? (
                 <div className="video-cover" onClick={() => setShowVideo(true)}>
                   <img src="https://img.youtube.com/vi/4PbdupC3wrg/maxresdefault.jpg" alt="Show Preview" className="yt-thumb-hd" />
                 ...
                 <iframe 
                   src="https://www.youtube.com/embed/4PbdupC3wrg?autoplay=1&vq=hd1080&rel=0&modestbranding=1" 
                   frameBorder="0" 
                  ...
                  <div className="car-track" style={{ transform: `translateX(-${currentIndex * 100}%)` }}>
                    {playlists.map((item, index) => (
                      <div key={index} className="car-item">
                        <img src={item.img} className="playlist-img" alt={item.title} />
        ...
        <div className="radio-bar">
          <div className="radio-inner">
            ...
            <div className="radio-display">
              ...
              <span className="status-label" style={{ fontSize: '9px', color: 'white' }}>você está ouvindo</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <style jsx global>{`
        ...
        .nav-item { color: white; text-decoration: none; font-size: 11px; letter-spacing: 0.15em; text-transform: uppercase; font-weight: bold; transition: 0.3s; cursor: pointer; }
        ...
        /* CSS DA CAPA HD */
        .video-player-container { width: 100%; max-width: 540px; margin: 60px auto; aspect-ratio: 16/9; background: #000; box-shadow: 0 50px 100px rgba(0,0,0,0.9); position: relative; overflow: hidden; }
        ...
        .play-triangle { width: 0; height: 0; border-style: solid; border-width: 25px 0 25px 45px; border-color: transparent transparent transparent #ffffff; filter: drop-shadow(0 0 10px rgba(0,0,0,0.5)); }
        ...
        .anim-fade-up { opacity: 0; transform: translateY(30px); animation: reveal 0.6s ease forwards; }
