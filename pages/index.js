...
export default function Inicio() {
  ...
  // Lógica do Preloader (Simulação de carregamento de ativos)
  useEffect(() => {
  ...
  return (
    <div style={{ backgroundColor: 'black', minHeight: '100vh', color: 'white', overflowX: 'hidden', fontFamily: "'Avant Garde', sans-serif" }}>
      ...
      <div style={{ position: 'relative', zIndex: 10, opacity: loading ? 0 : 1, transition: 'opacity 1s ease-in-out' }}>
        ...
        <main style={{ paddingTop: '220px', textAlign: 'center', maxWidth: '1200px', margin: '0 auto', paddingBottom: '150px' }}>
          
          {/* CITAÇÃO HERO */}
          <section style={{ marginBottom: '140px', padding: '0 20px' }}>
          ...
          {/* CAIXA DO SHOW (PADRONIZADA) */}
          <section style={{ marginBottom: '160px', padding: '0 20px' }}>
          ...
          {/* CARROSSEL PLAYLISTS (PADRONIZADO) */}
          <section style={{ marginBottom: '100px' }}>
             <div className="portal-card" style={{ marginBottom: '60px' }}>
      ...
      <style jsx global>{`
        ...
        /* PADRONIZACAO DAS CAIXAS */
        .portal-card { 
          max-width: 800px; margin: 0 auto 40px; padding: 25px 40px; 
          background: rgba(255,255,255,0.03); border: 1px solid rgba(168, 85, 247, 0.3); 
          border-radius: 4px; backdrop-filter: blur(10px); transition: 0.4s;
        }
        .portal-card:hover { transform: translateY(-5px); border-color: #a855f7; background: rgba(168, 85, 247, 0.08); }
        .title-low { font-size: 28px; text-transform: lowercase; font-weight: 300; margin: 0; color: white; }
        .subtitle-bold { font-size: 20px; text-transform: lowercase; font-weight: bold; margin: 10px 0 0; color: #a855f7; }

        /* VIDEO E CARROSSEL */
        .video-wrapper { width: 100%; maxWidth: 612px; margin: 0 auto; aspect-ratio: 16/9; box-shadow: 0 40px 100px rgba(0,0,0,0.8); }
        ...
        .playlist-card img { width: 100%; aspect-ratio: 1/1; object-fit: cover; border-radius: 4px; margin-bottom: 25px; transition: 0.5s; border: 1px solid rgba(255,255,255,0.05); }
        ...
        .btn-ouca { background: none; border: 1px solid #a855f7; color: #a855f7; font-size: 10px; padding: 12px 24px; cursor: pointer; letter-spacing: 0.2em; font-weight: bold; text-transform: lowercase; transition: 0.3s; }
        .btn-ouca:hover { background: #a855f7; color: white; transform: scale(1.05); }
        
        .footer { padding: 80px 20px 150px; text-align: center; border-top: 1px solid rgba(255,255,255,0.05); }
        .footer-title { font-size: 20px; font-weight: bold; text-transform: uppercase; margin-bottom: 20px; }
        .phone { font-weight: bold; margin-top: 15px; font-size: 16px; }
        .copyright { font-size: 10px; color: rgba(255,255,255,0.3); margin-top: 60px; }

        .fixed-player { position: fixed; bottom: 0; width: 100%; z-index: 100; background: rgba(0,0,0,0.95); backdrop-filter: blur(20px); border-top: 1px solid rgba(255,255,255,0.05); padding: 15px 40px; }
